...
if (count($_POST) > 0) {
    ...
    mysql_select_db("cook", $conn);
    $result = mysql_query("SELECT * FROM admin WHERE username='" . $_POST["username"] . "' AND password='" . $_POST["password"] . "'", $conn);
    ...
    <font color="white">
        ...
        <form method="POST">
            <table cellpadding="10" cellspacing="1" width="500" align="center" class="login">
                <tr><td align="center" colspan="2">ADMIN</td></tr>
